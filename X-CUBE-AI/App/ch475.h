...
#include "ch475_config.h"
#include "ai_platform.h"

/******************************************************************************/
#define AI_CH475_MODEL_NAME          "ch475"
#define AI_CH475_ORIGIN_MODEL_NAME   "ch475"

/******************************************************************************/
#define AI_CH475_ACTIVATIONS_ALIGNMENT   (4)
#define AI_CH475_INPUTS_IN_ACTIVATIONS   (4)
#define AI_CH475_OUTPUTS_IN_ACTIVATIONS  (4)

/******************************************************************************/
#define AI_CH475_IN_NUM        (1)

AI_DEPRECATED
#define AI_CH475_IN \
  ai_ch475_inputs_get(AI_HANDLE_NULL, NULL)

#define AI_CH475_IN_SIZE { \
  AI_CH475_IN_1_SIZE, \
}
#define AI_CH475_IN_SIZE_BYTES { \
  AI_CH475_IN_1_SIZE_BYTES, \
}
#define AI_CH475_IN_1_FORMAT      (AI_BUFFER_FORMAT_FLOAT)
#define AI_CH475_IN_1_CHANNEL     (1)
#define AI_CH475_IN_1_SIZE        (1)
#define AI_CH475_IN_1_SIZE_BYTES  (4)

/******************************************************************************/
#define AI_CH475_OUT_NUM       (1)

AI_DEPRECATED
#define AI_CH475_OUT \
  ai_ch475_outputs_get(AI_HANDLE_NULL, NULL)

#define AI_CH475_OUT_SIZE { \
  AI_CH475_OUT_1_SIZE, \
}
#define AI_CH475_OUT_SIZE_BYTES { \
  AI_CH475_OUT_1_SIZE_BYTES, \
}
#define AI_CH475_OUT_1_FORMAT      (AI_BUFFER_FORMAT_FLOAT)
#define AI_CH475_OUT_1_CHANNEL     (1)
#define AI_CH475_OUT_1_SIZE        (1)
#define AI_CH475_OUT_1_SIZE_BYTES  (4)

/******************************************************************************/
#define AI_CH475_N_NODES (1)
 ...
 * @ref ai_ch475_create. Both the activations memory buffer 
 ...
 */
AI_API_ENTRY
ai_buffer* ai_ch475_outputs_get(
  ai_handle network, ai_u16 *n_buffer);
 ...
 * header generated by the code generation tool. See AI_CH475_*
 * defines into file @ref ch475.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
