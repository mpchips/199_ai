...
#define AI_NET_OBJ_INSTANCE g_ch450
 
#undef AI_CH450_MODEL_SIGNATURE
#define AI_CH450_MODEL_SIGNATURE     "0xe4201430a1f2c94ea4c2a772bd1c1466"
...
#define AI_TOOLS_DATE_TIME   "2025-12-17T00:07:29+0800"

#undef AI_TOOLS_COMPILE_TIME
#define AI_TOOLS_COMPILE_TIME    __DATE__ " " __TIME__

#undef AI_CH450_N_BATCHES
#define AI_CH450_N_BATCHES         (1)

static ai_ptr g_ch450_activations_map[1] = AI_C_ARRAY_INIT;
static ai_ptr g_ch450_weights_map[1] = AI_C_ARRAY_INIT;
...
AI_NETWORK_OBJ_DECLARE(
  ...
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
    AI_BUFFER_SHAPE_INIT(AI_SHAPE_BCWH, 4, 1, 8, 1, 1),
    8, NULL, NULL),
  AI_TENSOR_LIST_IO_OBJ_INIT(AI_FLAG_NONE, AI_CH450_IN_NUM, &serving_default_keras_tensor0_output),
  AI_TENSOR_LIST_IO_OBJ_INIT(AI_FLAG_NONE, AI_CH450_OUT_NUM, &gemm_0_output),
  &gemm_0_layer, 0x1ea12286, NULL)
  ...
  ai_handle network, ai_network_report* report)
{
  ...
  {
    ai_network_report r = {
      .model_name        = AI_CH450_MODEL_NAME,
      .model_signature   = AI_CH450_MODEL_SIGNATURE,
  ...
  ai_handle* network, const ai_handle activations[], const ai_handle weights[])
{
  ...
  err = ai_ch450_create(network, AI_CH450_DATA_CONFIG);
  if (err.type != AI_ERROR_NONE) {
    return err;
  }
  
  if (ai_ch450_data_params_get(&params) != true) {
    err = ai_ch450_get_error(*network);
    return err;
  }
...
#endif
  if (ai_ch450_init(*network, &params) != true) {
    err = ai_ch450_get_error(*network);
  }
  return err;
}
...
AI_API_ENTRY
ai_i32 ai_ch450_forward(ai_handle network, const ai_buffer* input)
{
