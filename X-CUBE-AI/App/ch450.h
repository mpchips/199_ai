...
/******************************************************************************/
#define AI_CH450_MODEL_NAME          "ch450"
#define AI_CH450_ORIGIN_MODEL_NAME   "ch450"

/******************************************************************************/
#define AI_CH450_ACTIVATIONS_ALIGNMENT   (4)
#define AI_CH450_INPUTS_IN_ACTIVATIONS   (4)
#define AI_CH450_OUTPUTS_IN_ACTIVATIONS  (4)

/******************************************************************************/
#define AI_CH450_IN_NUM        (1)

AI_DEPRECATED
#define AI_CH450_IN \
  ai_ch450_inputs_get(AI_HANDLE_NULL, NULL)

#define AI_CH450_IN_SIZE { \
  AI_CH450_IN_1_SIZE, \
}
#define AI_CH450_IN_SIZE_BYTES { \
  AI_CH450_IN_1_SIZE_BYTES, \
}
#define AI_CH450_IN_1_FORMAT      (AI_BUFFER_FORMAT_FLOAT)
#define AI_CH450_IN_1_CHANNEL     (1)
#define AI_CH450_IN_1_SIZE        (1)
#define AI_CH450_IN_1_SIZE_BYTES  (4)

/******************************************************************************/
#define AI_CH450_OUT_NUM       (1)

AI_DEPRECATED
#define AI_CH450_OUT \
  ai_ch450_outputs_get(AI_HANDLE_NULL, NULL)

#define AI_CH450_OUT_SIZE { \
  AI_CH450_OUT_1_SIZE, \
}
#define AI_CH450_OUT_SIZE_BYTES { \
  AI_CH450_OUT_1_SIZE_BYTES, \
}
#define AI_CH450_OUT_1_FORMAT      (AI_BUFFER_FORMAT_FLOAT)
#define AI_CH450_OUT_1_CHANNEL     (1)
#define AI_CH450_OUT_1_SIZE        (1)
#define AI_CH450_OUT_1_SIZE_BYTES  (4)

/******************************************************************************/
#define AI_CH450_N_NODES (1)
 ...
 */
AI_API_ENTRY
ai_handle ai_ch450_destroy(ai_handle network);
 ...
 * @ref ai_ch450_create. Both the activations memory buffer 
 ...
 */
AI_API_ENTRY
ai_error ai_ch450_create_and_init(
 ...
 */
AI_API_ENTRY
ai_buffer* ai_ch450_outputs_get(
  ai_handle network, ai_u16 *n_buffer);
 ...
 * header generated by the code generation tool. See AI_CH450_*
 * defines into file @ref ch450.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
