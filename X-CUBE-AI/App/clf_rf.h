...
/******************************************************************************/
#define AI_CLF_RF_MODEL_NAME          "clf_rf"
#define AI_CLF_RF_ORIGIN_MODEL_NAME   "randomforest"

/******************************************************************************/
#define AI_CLF_RF_ACTIVATIONS_ALIGNMENT   (4)
#define AI_CLF_RF_INPUTS_IN_ACTIVATIONS   (4)
#define AI_CLF_RF_OUTPUTS_IN_ACTIVATIONS  (4)

/******************************************************************************/
#define AI_CLF_RF_IN_NUM        (1)

AI_DEPRECATED
#define AI_CLF_RF_IN \
  ai_clf_rf_inputs_get(AI_HANDLE_NULL, NULL)

#define AI_CLF_RF_IN_SIZE { \
  AI_CLF_RF_IN_1_SIZE, \
}
#define AI_CLF_RF_IN_SIZE_BYTES { \
  AI_CLF_RF_IN_1_SIZE_BYTES, \
}
#define AI_CLF_RF_IN_1_FORMAT      (AI_BUFFER_FORMAT_FLOAT)
#define AI_CLF_RF_IN_1_HEIGHT      (1)
#define AI_CLF_RF_IN_1_CHANNEL     (8)
#define AI_CLF_RF_IN_1_SIZE        (8)
#define AI_CLF_RF_IN_1_SIZE_BYTES  (32)

/******************************************************************************/
#define AI_CLF_RF_OUT_NUM       (2)

AI_DEPRECATED
#define AI_CLF_RF_OUT \
  ai_clf_rf_outputs_get(AI_HANDLE_NULL, NULL)

#define AI_CLF_RF_OUT_SIZE { \
  AI_CLF_RF_OUT_1_SIZE, \
  AI_CLF_RF_OUT_2_SIZE, \
}
#define AI_CLF_RF_OUT_SIZE_BYTES { \
  AI_CLF_RF_OUT_1_SIZE_BYTES, \
  AI_CLF_RF_OUT_2_SIZE_BYTES, \
}
#define AI_CLF_RF_OUT_1_FORMAT      (AI_BUFFER_FORMAT_S32)
#define AI_CLF_RF_OUT_1_CHANNEL     (1)
#define AI_CLF_RF_OUT_1_SIZE        (1)
#define AI_CLF_RF_OUT_1_SIZE_BYTES  (4)
#define AI_CLF_RF_OUT_2_FORMAT      (AI_BUFFER_FORMAT_FLOAT)
#define AI_CLF_RF_OUT_2_HEIGHT      (1)
#define AI_CLF_RF_OUT_2_CHANNEL     (3)
#define AI_CLF_RF_OUT_2_SIZE        (3)
#define AI_CLF_RF_OUT_2_SIZE_BYTES  (12)

/******************************************************************************/
#define AI_CLF_RF_N_NODES (1)
 ...
 * @ref ai_clf_rf_create. Both the activations memory buffer 
 ...
 */
AI_API_ENTRY
ai_buffer* ai_clf_rf_inputs_get(
 ...
 */
AI_API_ENTRY
ai_buffer* ai_clf_rf_outputs_get(
  ai_handle network, ai_u16 *n_buffer);
 ...
 * header generated by the code generation tool. See AI_CLF_RF_*
 * defines into file @ref clf_rf.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
