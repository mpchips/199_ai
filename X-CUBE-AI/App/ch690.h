...
/******************************************************************************/
#define AI_CH690_MODEL_NAME          "ch690"
#define AI_CH690_ORIGIN_MODEL_NAME   "ch690"

/******************************************************************************/
#define AI_CH690_ACTIVATIONS_ALIGNMENT   (4)
#define AI_CH690_INPUTS_IN_ACTIVATIONS   (4)
#define AI_CH690_OUTPUTS_IN_ACTIVATIONS  (4)

/******************************************************************************/
#define AI_CH690_IN_NUM        (1)

AI_DEPRECATED
#define AI_CH690_IN \
  ai_ch690_inputs_get(AI_HANDLE_NULL, NULL)

#define AI_CH690_IN_SIZE { \
  AI_CH690_IN_1_SIZE, \
}
#define AI_CH690_IN_SIZE_BYTES { \
  AI_CH690_IN_1_SIZE_BYTES, \
}
#define AI_CH690_IN_1_FORMAT      (AI_BUFFER_FORMAT_FLOAT)
#define AI_CH690_IN_1_CHANNEL     (1)
#define AI_CH690_IN_1_SIZE        (1)
#define AI_CH690_IN_1_SIZE_BYTES  (4)

/******************************************************************************/
#define AI_CH690_OUT_NUM       (1)

AI_DEPRECATED
#define AI_CH690_OUT \
  ai_ch690_outputs_get(AI_HANDLE_NULL, NULL)

#define AI_CH690_OUT_SIZE { \
  AI_CH690_OUT_1_SIZE, \
}
#define AI_CH690_OUT_SIZE_BYTES { \
  AI_CH690_OUT_1_SIZE_BYTES, \
}
#define AI_CH690_OUT_1_FORMAT      (AI_BUFFER_FORMAT_FLOAT)
#define AI_CH690_OUT_1_CHANNEL     (1)
#define AI_CH690_OUT_1_SIZE        (1)
#define AI_CH690_OUT_1_SIZE_BYTES  (4)

/******************************************************************************/
#define AI_CH690_N_NODES (1)
 ...
 * @ref ai_ch690_create. Both the activations memory buffer 
 ...
 */
AI_API_ENTRY
ai_buffer* ai_ch690_outputs_get(
  ai_handle network, ai_u16 *n_buffer);
 ...
 * header generated by the code generation tool. See AI_CH690_*
 * defines into file @ref ch690.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
