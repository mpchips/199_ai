...
#include "ch600_config.h"
#include "ai_platform.h"

/******************************************************************************/
#define AI_CH600_MODEL_NAME          "ch600"
#define AI_CH600_ORIGIN_MODEL_NAME   "ch600"

/******************************************************************************/
#define AI_CH600_ACTIVATIONS_ALIGNMENT   (4)
#define AI_CH600_INPUTS_IN_ACTIVATIONS   (4)
#define AI_CH600_OUTPUTS_IN_ACTIVATIONS  (4)

/******************************************************************************/
#define AI_CH600_IN_NUM        (1)

AI_DEPRECATED
#define AI_CH600_IN \
  ai_ch600_inputs_get(AI_HANDLE_NULL, NULL)

#define AI_CH600_IN_SIZE { \
  AI_CH600_IN_1_SIZE, \
}
#define AI_CH600_IN_SIZE_BYTES { \
  AI_CH600_IN_1_SIZE_BYTES, \
}
#define AI_CH600_IN_1_FORMAT      (AI_BUFFER_FORMAT_FLOAT)
#define AI_CH600_IN_1_CHANNEL     (1)
#define AI_CH600_IN_1_SIZE        (1)
#define AI_CH600_IN_1_SIZE_BYTES  (4)

/******************************************************************************/
#define AI_CH600_OUT_NUM       (1)

AI_DEPRECATED
#define AI_CH600_OUT \
  ai_ch600_outputs_get(AI_HANDLE_NULL, NULL)

#define AI_CH600_OUT_SIZE { \
  AI_CH600_OUT_1_SIZE, \
}
#define AI_CH600_OUT_SIZE_BYTES { \
  AI_CH600_OUT_1_SIZE_BYTES, \
}
#define AI_CH600_OUT_1_FORMAT      (AI_BUFFER_FORMAT_FLOAT)
#define AI_CH600_OUT_1_CHANNEL     (1)
#define AI_CH600_OUT_1_SIZE        (1)
#define AI_CH600_OUT_1_SIZE_BYTES  (4)

/******************************************************************************/
#define AI_CH600_N_NODES (1)
 ...
 * @ref ai_ch600_create. Both the activations memory buffer 
 ...
 */
AI_API_ENTRY
ai_buffer* ai_ch600_outputs_get(
  ai_handle network, ai_u16 *n_buffer);
 ...
 * header generated by the code generation tool. See AI_CH600_*
 * defines into file @ref ch600.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
